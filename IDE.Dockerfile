...
RUN apt update && apt install -y sudo openssh-server curl wget git python3-pip nodejs npm ripgrep fzf ranger libjpeg8-dev zlib1g-dev pynvim pyvim contextlib2 python-dev python3-dev libxtst-dev gettext libtool libtool-bin autoconf automake cmake g++ pkg-config unzip build-essential
